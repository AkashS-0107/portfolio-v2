...
export const Skills: React.FC<SkillsProps> = ({ onSelectProject }) => {
  ...
  return (
    <section id="skills" className="py-24 px-4 sm:px-6 lg:px-8 border-t border-[#27272A] bg-[#09090B] relative">
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <span className="text-xs font-mono-tech text-[#9E9A93] bg-[#141418] px-3 py-1 rounded border border-[#27272A]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {groupsToDisplay.map((group) => (
            <div
              key={group.category}
              className="p-6 rounded bg-[#141418] border border-[#27272A] hover:border-[#33333C] transition-all flex flex-col justify-between shadow-xl group"
            >
              <div>
                {/* Category Header */}
              ...
              {/* Relationship Feedback Bar (Communicates 'I know this because I used it') */}
