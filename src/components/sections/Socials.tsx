...
export const Socials: React.FC = () => {
  ...
  return (
    <section id="socials" className="py-24 px-4 sm:px-6 lg:px-8 border-t border-[#27272A] relative bg-[#09090B]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {activeSocials.map((social) => {
            ...
            return (
              <div
                key={social.id}
                className="p-6 sm:p-7 rounded bg-[#141418] border border-[#27272A] hover:border-[#C56A4A]/50 transition-all flex flex-col justify-between shadow-xl group"
              >
