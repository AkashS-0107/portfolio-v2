...
export const Internships: React.FC = () => {
  ...
  return (
    <section id="internships" className="py-24 px-4 sm:px-6 lg:px-8 border-t border-[#27272A] bg-[#09090B] relative">
                  ...
                  <div className="pt-4 border-t border-[#27272A] space-y-3 font-mono-tech">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      {internship.responsibilities.map((resp, idx) => (
                        <div key={idx} className="flex items-start gap-2.5 text-xs text-[#F4F4F6] bg-[#09090B] p-2.5 rounded border border-[#27272A]">
